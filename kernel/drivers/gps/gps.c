...
#endif 
/******************************************************************************/
DEVICE_ATTR(pwrctl,     S_IWUGO | S_IRUGO, mt3326_show_pwrctl,  mt3326_store_pwrctl);
DEVICE_ATTR(suspend,    S_IWUGO | S_IRUGO, mt3326_show_suspend,mt3326_store_suspend);
DEVICE_ATTR(status,     S_IWUGO | S_IRUGO, mt3326_show_status, mt3326_store_status);
DEVICE_ATTR(state,      S_IWUGO | S_IRUGO, mt3326_show_state,  mt3326_store_state);
DEVICE_ATTR(pwrsave,    S_IWUGO | S_IRUGO, mt3326_show_pwrsave,mt3326_store_pwrsave);
#if defined(GPS_CONFIGURABLE_RESET_DELAY)
DEVICE_ATTR(rdelay,     S_IWUGO | S_IRUGO, mt3326_show_rdelay ,mt3326_store_rdelay);
#endif 
