...
/*
            LCD_LAYER_ID dID = LCD_LAYER_1;        
            LCD_LayerEnable(dID, true);   
            LCD_LayerSetAddress(dID, temp_buf_pa);    
            LCD_LayerSetSize(dID, 160, 160);    
            LCD_LayerSetFormat(dID, LCD_LAYER_FORMAT_RGB888);    
            LCD_LayerSetOffset(dID, 0, 0);    
            //DISP_UpdateScreen(false, 0, 0, 160, 160);

            LCD_LAYER_ID dID2 = LCD_LAYER_2;        
            LCD_LayerEnable(dID2, true);   
            LCD_LayerSetAddress(dID2, dec_dst_pa);    
            LCD_LayerSetSize(dID2, 160, 160);    
            LCD_LayerSetFormat(dID2, LCD_LAYER_FORMAT_ARGB8888);    
            LCD_LayerSetOffset(dID2, 0, 200);    
            DISP_UpdateScreen(false, 0, 0, 160, 360);
*/            
            if(dec_dst_va != 0)
            {
