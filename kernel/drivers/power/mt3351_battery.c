...
/*****************************************************************************
 *  EFUSE ADC Slope and Offset Mask
 ****************************************************************************/
...
/*
 *   The following table contains the parameters that are calculated from the fomula: 
 *   ((2.8 x Rnormal)/(24 + Rnormal) x 1024/2.8
 *   Besides, the range of temporary is from -10c to 60c
 */
