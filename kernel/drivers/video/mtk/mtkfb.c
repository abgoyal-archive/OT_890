...
/**
    Android adopts openGL as surface flinger backend engine, and openGL
    only support ABGR8888 color format while MT6516 LCD HW only support
    ARGB8888 color format. The following function try to work around the
    R/B order mistach issue via layer swap byte and color matrix.
*/
