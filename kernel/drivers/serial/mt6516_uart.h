...
#ifndef MT6516_UART_H
#define MT6516_UART_H
...
#define UART_VFIFO_PORT1            (0x80110100 + IO_OFFSET)
#define UART_VFIFO_PORT2            (0x80110200 + IO_OFFSET)
#define UART_VFIFO_PORT3            (0x80110300 + IO_OFFSET)
#define UART_VFIFO_PORT4            (0x80110400 + IO_OFFSET)
#define UART_VFIFO_PORT5            (0x80110500 + IO_OFFSET)
#define UART_VFIFO_PORT6            (0x80110600 + IO_OFFSET)
#define UART_VFIFO_PORT7            (0x80110700 + IO_OFFSET)
...
{   .DMA_CNT = (VFIFO_DMA_COUNT_REG*)((BASE)+ 0x080 * (N+1) + 0x10), \
    .DMA_CTRL = (VFIFO_DMA_CTRL_REG*)((BASE)+ 0x080 * (N+1) + 0x14), \
    .DMA_START= (VFIFO_DMA_START_REG*)((BASE)+ 0x080 * (N+1) + 0x18), \
    .DMA_INTSTA = (VFIFO_DMA_INTSTA_REG*)((BASE)+ 0x080 * (N+1) + 0x1c), \
    .DMA_ACKINT = (VFIFO_DMA_ACKINT_REG*)((BASE)+ 0x080 * (N+1) + 0x20), \
    .DMA_PGMADDR = (VFIFO_DMA_PGMADDR_REG*)((BASE)+ 0x080 * (N+1) + 0x2c), \
    .DMA_WRPTR = (VFIFO_DMA_WRPTR_REG*)((BASE)+ 0x080 * (N+1) + 0x30), \
    .DMA_RDPTR = (VFIFO_DMA_RDPTR_REG*)((BASE)+ 0x080 * (N+1) + 0x34), \
    .DMA_FFCNT = (VFIFO_DMA_FFCNT_REG*)((BASE)+ 0x080 * (N+1) + 0x38), \
    .DMA_FFSTA = (VFIFO_DMA_FFSTA_REG*)((BASE)+ 0x080 * (N+1) + 0x3c), \
    .DMA_ALTLEN = (VFIFO_DMA_ALTLEN_REG*)((BASE)+ 0x080 * (N+1) + 0x40), \
    .DMA_FFSIZE = (VFIFO_DMA_FFIZE_REG*)((BASE)+ 0x080 * (N+1) + 0x44), \
}
