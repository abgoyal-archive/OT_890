 ...
 *     for monitoring performace!
 *
 * modification history
 * ----------------------------------------
 * 20091021, Shu-Hsin Chang updated
 * 20090511, Shu-Hsin Chang written
 * ----------------------------------------
 ******************************************************************************/
#include <asm/io.h>
...
/******************************************************************************
 Dcache Miss Rate Measure API
 Desciption : total read/write requests of the instruction cache
            : total read/write miss of the instruction cache 
******************************************************************************/
...
/******************************************************************************
 Icache Miss Rate Measure API
 Desciption : total read requests of the instruction cache
            : total read miss of the instruction cache 
******************************************************************************/
...
/******************************************************************************
 ARM9 ACTIVE Measure API
 Desciption : ARM9 total active count, it only counts when ARM9 is active
******************************************************************************/
...
/******************************************************************************
 DTLB Penalty Measure API
 Desciption : It counts ARM9 stall cycles when data TLB miss occurs
******************************************************************************/
...
/******************************************************************************
 ITLB Penalty Measure API
 Desciption : It counts ARM9 stall cycles when instruction TLB miss occurs
******************************************************************************/
...
/******************************************************************************
 DCache Penalty Measure API
 Desciption : It counts ARM9 stall cycles when data cache miss occurs
******************************************************************************/
...
/******************************************************************************
 ICache Penalty Measure API
 Desciption : It counts ARM9 stall cycles when instruction cache miss occurs
******************************************************************************/
...
/******************************************************************************
 DEXT Penalty Measure API
 Desciption : It counts when DEXT (data external write buffer) stall ARM9
******************************************************************************/
...
/******************************************************************************
 IEXT Penalty Measure API
 Desciption : It counts when IEXT (instruction external write buffer) stall ARM9
******************************************************************************/
...
/******************************************************************************
 DAHB Penalty Measure API
 Desciption : It counts when data bus stall ARM9
            : It counts total request number of the data bus
******************************************************************************/
...
/******************************************************************************
 IAHB Penalty Measure API
 Desciption : It counts when instruction bus stall ARM9
            : It counts total request number of the instruction bus
******************************************************************************/
...
/******************************************************************************
 Monitor uninitialization function
******************************************************************************/
