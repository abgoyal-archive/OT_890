...
/* linux/drivers/i2c/busses/i2c-mt3351.c
 *
 * (C) Copyright 2008 
 * MediaTek <www.mediatek.com>
 * Infinity Chen <infinity.chen@mediatek.com>
 *
 * MT3351 I2C Bus Controller
 *
 ...
 * 02. MT3351 doesn't support to probe client device (only send slave addr)?
 *     => Not required.
 * 03. MT3351 doesn't support 10-bit slave address?
 *     => TBC
...
/*
static int mt3351_i2c_control(struct i2c_adapter *adapter, unsigned int cmd, 
                              unsigned long arg)
{
	struct mt3351_i2c *i2c = i2c_get_adapdata(adapter);
