...
/*
 *	MTK Real Time Clock interface for Linux	
 *
 *	Copyright (C) 2008 MTK, Inc.
 *      Author: Irene Liao <irene.liao@mediatek.com> 
 *
 *
...
/******************************************************************************
 * mt3351_rtc_IsProt_Pass
 * 
 * DESCRIPTION:
 *   check RTC pretection
 * 
 * PARAMETERS: 
 *   None
 * 
...
/******************************************************************************
 * mt3351_rtc_IsInhibit_WR
 * 
 * DESCRIPTION:
 *   check RTC Inhibit bit
 * 
 * PARAMETERS: 
 *   None
 * 
 ...
 * 
 * DESCRIPTION:
 *   set RTC alarm time (alm only supports maxium to hour)
 * 
 * PARAMETERS: 
 *   struct device *dev, struct rtc_time *rtc_tm
 * 
 ...
 * 
 * DESCRIPTION:
 *   link this function to linux kernel funciton: set_rtc
 * 
 * PARAMETERS: 
 *   None
 * 
...
/******************************************************************************
 * mt3351_rtc_proc_output
 * 
 * DESCRIPTION:
 *   Read rtc proc information
 * 
 * PARAMETERS: 
 *   char *buf
 * 
 ...
 * -----------------------------------------------
 * 2008, Irene written
 * 2009/03/30, Shu-Hsin add seq_printf
 * -----------------------------------------------
 ******************************************************************************/
 ...
 * -----------------------------------------------
 * 2008, Irene written
 * 2009/03/30, Shu-Hsin marked this function due to useless
 * -----------------------------------------------
 ******************************************************************************/
#if 0
 ...
 * 
 * PARAMETERS: 
 *   int fd, struct file *filp, int on
 * 
 * RETURNS: 
 *   int
 * 
 ...
 * -----------------------------------------------
 * 2008, Irene written
 * 2009/03/30, Shu-Hsin change function parameters
 * -----------------------------------------------
 ******************************************************************************/
