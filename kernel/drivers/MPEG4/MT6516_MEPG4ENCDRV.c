...
typedef enum 
{
SET_MP4_CODEC_COMD = 1,
SET_MP4_DEC_CODEC_CONF = 2,
SET_MP4_DEC_IRQ_MASK = 3,
SET_MP4_DEC_VOP_STRUCT0 = 4,
SET_MP4_DEC_VOP_STRUCT1 = 5,
SET_MP4_DEC_VOP_STRUCT2 = 6,
SET_MP4_DEC_MB_STRUCT0 = 7,
SET_MP4_DEC_DACP_ADDR = 8,
SET_MP4_DEC_DATA_STROE_ADDR = 9,
SET_MP4_DEC_QS_ADDR = 10,
SET_MP4_DEC_MVP_ADDR = 11,
SET_MP4_DEC_VLC_ADDR = 12,
SET_MP4_DEC_VLC_BIT = 13,
SET_MP4_DEC_VLC_LIMIT = 14,
SET_MP4_DEC_REC_ADDR = 15,
SET_MP4_DEC_REF_ADDR = 16,
GET_MP4_DEC_REC_ADDR = 17,
GET_MP4_DEC_REF_ADDR = 18,
SET_MP4_DEC_YUV_BUFFER_FILL_BLACK = 26,
SET_MP4_CODEC_COMD_START = 27,
} MPEG4_DECODER_CMD;
...
UINT32 width;
UINT32 height;
} yuv_buffer_from_user;

yuv_buffer_from_user *pg_yuv_buffer_from_user;
...
UINT8 * va;
UINT32 pa;
UINT32 size;  // number MB perframe * 32 (ex. CIF: (352*288/256) * 32)
} dec_data_store;

dec_data_store g_dec_data_store;

typedef struct
{
UINT8 * va;
UINT32 pa;
UINT32 size;  // ((mb_x_limit+3)/4)*4*mb_y_limit
} dec_qs;
...
set_dec_vlc * pg_dec_vlc_from_user;
...
dec_done_param * pg_dec_done_param;
...
//move out ISR.
            ...
            {  // stuffing bits: one zero and followed by 1 to 7 ones
                mp4_putbits((UINT8 *)g_mp4_enc_hal_info.v_enc_bitstreams_ptr, (INT32 *)&bitcnt,0,1);
                while ((bitcnt & 7) != 0)
                {
                    mp4_putbits((UINT8 *)g_mp4_enc_hal_info.v_enc_bitstreams_ptr, (INT32 *)&bitcnt,1,1);
                }
            } 
            else 
