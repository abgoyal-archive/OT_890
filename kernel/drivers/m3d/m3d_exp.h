 ...
 * Add-in M3D power management control scheme
 *
...
{
/*   
   AlphaTestUnit AlphaTest;
   BlendTestUnit BlendTest;
   DepthTestUnit DepthTest;
   LogicTestUnit LogicTest;
*/   
