 ...
 * 
 *
 * Jul 14 2009 mtk02174
 * [DUMA00123228] [MPEG4 playback]press power key can not awake the device after enter suspend mode
 * cache flush behavior should be put inside the condition when (g_PowerState == POWER_ON)
 *
 * Jul 10 2009 mtk02174
 * [DUMA00123036] [OpenGL ES1.1]Cannot wake up device after conformance test is when auto suspend
 * 
 *
 * Jul 10 2009 mtk02174
 * [DUMA00123036] [OpenGL ES1.1]Cannot wake up device after conformance test is when auto suspend
 ...
 *
 * Jul 10 2009 mtk02174
 * [DUMA00122782] [OpenGL ES1.1]Error in conformance test
 * 
 *
 * Jul 8 2009 mtk02174
 * [DUMA00122782] [OpenGL ES1.1]Error in conformance test
 ...
 *
 * Jul 7 2009 mtk02174
 * [DUMA00122624] [Power Management] M3D power does not turn off
 * 
 *
 * Jul 5 2009 mtk02174
 * [DUMA00006853] [OpenGLES 1.1] Fix lint warning
 ...
 * Jul 3 2009 mtk02174
 * [DUMA00008385] [OpenGL ES 1.X] M3D H/W Driver check-in, use the share memory for IPC
 * For optimization, use share memory for IPC
 *
...
/*
    printk(KERN_INFO"[M3D] ColorBase    : 0x%x\n", pContext->ColorBase);
    printk(KERN_INFO"[M3D] BufferWidth  : 0x%x\n", pContext->BufferWidth);
    printk(KERN_INFO"[M3D] BufferHeight : 0x%x\n", pContext->BufferHeight);
    printk(KERN_INFO"[M3D] DepthBase    : 0x%x\n", pContext->DepthBase);
    printk(KERN_INFO"[M3D] StencilBase  : 0x%x\n", pContext->StencilBase);
*/
}
...
/*
printk("=============UpdateTexDrawOES with scissor i_x = %x=============\n", i_x);
printk("=============UpdateTexDrawOES with scissor i_y = %x=============\n", i_y);
printk("=============UpdateTexDrawOES with scissor draw_right = %x=============\n", draw_right);
printk("=============UpdateTexDrawOES with scissor draw_top = %x=============\n", draw_top);

printk("=============UpdateTexDrawOES with scissor scissor_left_backup = %x=============\n", scissor_left_backup);
printk("=============UpdateTexDrawOES with scissor scissor_bottom_backup = %x=============\n", scissor_bottom_backup);
printk("=============UpdateTexDrawOES with scissor scissor_right_backup = %x=============\n", scissor_right_backup);
printk("=============UpdateTexDrawOES with scissor scissor_top_backup = %x=============\n", scissor_top_backup);

printk("=============UpdateTexDrawOES with scissor new_scissor_left = %x=============\n", new_scissor_left);
printk("=============UpdateTexDrawOES with scissor new_scissor_bottom = %x=============\n", new_scissor_bottom);
printk("=============UpdateTexDrawOES with scissor new_scissor_right = %x=============\n", new_scissor_right);
printk("=============UpdateTexDrawOES with scissor new_scissor_top = %x=============\n", new_scissor_top);
*/
