...
/* include/linux/kxsd9.h - ADXL345 motion sensor driver
 *
...
/* IOCTLs for adxl345 misc. device library */
#define ADXL345IO						   	0x85
#define ADXL345_IOCTL_INIT                  _IO(ADXL345IO,  0x01)
#define ADXL345_IOCTL_READ_CHIPINFO         _IOR(ADXL345IO, 0x02, int)
#define ADXL345_IOCTL_READ_SENSORDATA       _IOR(ADXL345IO, 0x03, int)
