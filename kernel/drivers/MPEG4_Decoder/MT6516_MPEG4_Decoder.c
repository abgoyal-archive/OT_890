...
{
/*
    MP4_DEC_DEBUG("MP4_DEC_CODEC_CONF(+0x200) = 0x%08x\n",HW_READ(MP4_DEC_CODEC_CONF));
    MP4_DEC_DEBUG("MP4_DEC_STS(+0x204) = 0x%08x\n",HW_READ(MP4_DEC_STS));
    MP4_DEC_DEBUG("MP4_DEC_IRQ_MASK(+0x208) = 0x%08x\n",HW_READ(MP4_DEC_IRQ_MASK));
    MP4_DEC_DEBUG("MP4_DEC_IRQ_STS(+0x20c) = 0x%08x\n",HW_READ(MP4_DEC_IRQ_STS));
    MP4_DEC_DEBUG("MP4_DEC_IRQ_ACK(+0x210) = 0x%08x\n",HW_READ(MP4_DEC_IRQ_ACK));
    MP4_DEC_DEBUG("MP4_DEC_REF_ADDR(+0x224) = 0x%08x\n",HW_READ(MP4_DEC_REF_ADDR));
    MP4_DEC_DEBUG("MP4_DEC_REC_ADDR(+0x228) = 0x%08x\n",HW_READ(MP4_DEC_REC_ADDR));
    MP4_DEC_DEBUG("MP4_DEC_DATA_STROE_ADDR(+0x230) = 0x%08x\n",HW_READ(MP4_DEC_DATA_STROE_ADDR));
    MP4_DEC_DEBUG("MP4_DEC_DACP_ADDR(+0x234) = 0x%08x\n",HW_READ(MP4_DEC_DACP_ADDR));
    MP4_DEC_DEBUG("MP4_DEC_MVP_ADDR(+0x238) = 0x%08x\n",HW_READ(MP4_DEC_MVP_ADDR));
    MP4_DEC_DEBUG("MP4_DEC_VOP_STRUCT0(+0x240) = 0x%08x\n",HW_READ(MP4_DEC_VOP_STRUCT0));
    MP4_DEC_DEBUG("MP4_DEC_VOP_STRUCT1(+0x244) = 0x%08x\n",HW_READ(MP4_DEC_VOP_STRUCT1));
    MP4_DEC_DEBUG("MP4_DEC_VOP_STRUCT2(+0x248) = 0x%08x\n",HW_READ(MP4_DEC_VOP_STRUCT2));
    MP4_DEC_DEBUG("MP4_DEC_MB_STRUCT0(+0x24c) = 0x%08x\n",HW_READ(MP4_DEC_MB_STRUCT0));
    MP4_DEC_DEBUG("MP4_DEC_VLC_ADDR(+0x260) = 0x%08x\n",HW_READ(MP4_DEC_VLC_ADDR));
    MP4_DEC_DEBUG("MP4_DEC_VLC_BIT(+0x264) = 0x%08x\n",HW_READ(MP4_DEC_VLC_BIT));
    MP4_DEC_DEBUG("MP4_DEC_VLC_LIMIT(+0x268) = 0x%08x\n",HW_READ(MP4_DEC_VLC_LIMIT));
    MP4_DEC_DEBUG("MP4_DEC_VLC_WORD(+0x26C) = 0x%08x\n",HW_READ(MP4_DEC_VLC_WORD));
    MP4_DEC_DEBUG("MP4_DEC_VLC_BITCNT(+0x270) = 0x%08x\n",HW_READ(MP4_DEC_VLC_BITCNT));
    MP4_DEC_DEBUG("MP4_DEC_QS_ADDR(+0x27c) = 0x%08x\n",HW_READ(MP4_DEC_QS_ADDR));   
*/
}
