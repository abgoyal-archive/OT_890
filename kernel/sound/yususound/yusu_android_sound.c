 ...
 * $Log:$
 *
 * 09 22 2010 chipeng.chang
 * [ALPS00123207] [Power management]Ringtone was cut to two parts when receive message or email in suspend mode
 * add wake lock in audio driver.
 *
 ...
 *
 * 07 09 2010 chipeng.chang
 * [ALPS00002927][Need Patch] [Volunteer Patch] disable audioflinger log 
 * remove log .
 *
 ...
 *
 * 06 30 2010 chipeng.chang
 * [ALPS00002795][Need Patch] [Volunteer Patch] audio driver
 * fix kernel error
 *
 * 06 30 2010 chipeng.chang
 * [ALPS00002795][Need Patch] [Volunteer Patch] audio driver
 * modify data concurrentcy.
 *
 * 06 24 2010 chipeng.chang
 * [ALPS00002682][Need Patch] [Volunteer Patch] ALPS.10X.W10.11 Volunteer patch for sound suspend
 * .remove msleep in suspend.
 *
 * 06 22 2010 chipeng.chang
 * [ALPS00008339][Power Management] Suspend current is a little high after music pause
 * .modify sound seuspend flow when not in standy.
 *
 * 06 16 2010 chipeng.chang
 * [ALPS00005495][PM Performance]Cannot reach suspend current after sync email
 * when suspend if amp is opened and is not in speehc mode , close amp , and open it when resume.
 *
 ...
 *
 * 06 03 2010 chipeng.chang
 * [ALPS00002374]Add TCM Support
 * .add for TCM
 *
 ...
 *
 * 05 28 2010 chipeng.chang
 * [ALPS00002241][BT]Music App does not entry when connect bt ear phone
 * modify Audiotrack fraomecount size for Bt , shoukd not use latency instead of use aframecount.
 *
 * 05 27 2010 chipeng.chang
 * [ALPS00007274][OPPO][Phone sound]Phone will sound  "ci ci " noise when plug out USB when Device is mounting
 * when resume  clear buf and clock count use spin lock.
 *
 * 05 24 2010 chipeng.chang
 * [ALPS00007026][Headset]Cannot hear any sound form phone recevier when plug the headset
 * when suspend , keep staus of amp.
 *
 * 05 22 2010 chipeng.chang
 * [ALPS00006667][MPEG4 playback]Seek the video which video stream can not be supported by our device, audio will delay for several seconds
 * .add solution for asm buffer timeout.
 *
 ...
 *
 * 04 27 2010 chipeng.chang
 * [ALPS00005440][Phone Sound] the file plays with much noise after press power key
 * modify kernel buffer when underflow
 *
 *******************************************************************************/
...
/*--------------------------------------------------------------------------
static variable declaration end
--------------------------------------------------------------------------*/
