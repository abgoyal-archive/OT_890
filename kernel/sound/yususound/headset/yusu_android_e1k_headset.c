 ...
 *
 * 08 10 2010 james.lo
 * [ALPS00003322] [Monkey] Fix ALPS00123124
 * Fix ALPS00123124.
 *
 * 08 10 2010 james.lo
 * [ALPS00123124] [Yongchao Tang  2010.08.08]

Dear James:

    I have get the new log (log17.rar) in W10.32 p17, the log contain Touch log, Please help to check this issue. Thanks!


[Yongchao Tang  2010.08.07]

Dear James:

    I have get the new log in W10.32 p16, the log contain Touch log, Please help to check this issue. Thanks!
...
Please help to check this issue, this issue happen again, Thanks!


[Caixia Song 2010.08.06]

Dear James:

   Please Help to check this issue,Thanks!

 * [ALPS00123124] [Call]The phone may answer the call automaticlly with earphone
 * after check the micbias, start to bitton detection.
 *
 * 08 06 2010 james.lo
 * [ALPS00123124] [Call]The phone may answer the call automaticlly with earphone
 * add dekay for waiting the MICbias ready.
 *
 * 06 29 2010 james.lo
 * [ALPS00002761][Need Patch] [Volunteer Patch] ALPS.10X.W10.11 Volunteer patch for 
 * add log for QA.
 *
 * 06 22 2010 james.lo
 * [ALPS00008348][Power Management] Suspend current is high when insert headset 
 * Fix CR8348..
 *
 * 06 10 2010 james.lo
 * [ALPS00008018][Audio Jack]Can't use Audio Jack to disconnect call 
 * Fix CR 8018.
 *
 * 05 25 2010 james.lo
 ...
 *
 * 05 24 2010 james.lo
 * [ALPS00007022][Headset]Cannot accept the incoming call when boot up with headset 
 * [ALPS00007022] [Headset]Cannot accept the incoming call when boot up with headset
 * Fix ALPS00007022.
 *
 * 05 19 2010 james.lo
 * [ALPS00006594][Audio Jack] Cannot receive the MT when short press Audio Jack key 
 * Fix ALPS00006594.
 *
 * 05 17 2010 james.lo
 * [ALPS00006556][Audio Jack]When insert Audio Jack, sound will still play 1~2 seconds from loudspeaker 
 * Fix ALPS00006556..
 *
 * 04 27 2010 james.lo
...
constant defination
----------------------------------------------------------------------*/
int Check_MIC_Power(void)
{
	int adc_channel_voltage = -1;

	PRINTK("[Headset] Check_MIC_Power... \n");
	...
	while(1)
	{
		...
		{
			PRINTK("[Headset] check high to low : %d mV \n", adc_channel_voltage);
			return 1;
		}		
	}
}
...
int Check_headset_type(void)
{
	...
	//PRINTK("[Headset] Check_MIC_Power on Check_headset_type\n");
	//Check_MIC_Power();
	...
	PRINTK("[Headset] volt:%d, range:%d ~ %d \n", adc_channel_voltage, NORMAL_EARPHONE_LOW, NORMAL_EARPHONE_HIIGH);
