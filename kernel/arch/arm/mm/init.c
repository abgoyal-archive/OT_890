...
void free_initmem(void)
{
	...
	printk("__tcm_start(%x, %x) pfn=%x, __tcm_end(%x, %x) pfn=%x", &__tcm_start, __pa(&__tcm_start), __phys_to_pfn(__pa(&__tcm_start)), &__tcm_end, __pa(&__tcm_end), __phys_to_pfn(__pa(&__tcm_end)));
