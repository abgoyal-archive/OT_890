...
/*
    u32 u4FlareHistBuffAddr;// must be 10(registers) x 4(32 bits) = 40 bytes
    u32 u4RAWACCMAddr;// must be 4(registers) x 4(32 bits) = 16 bytes
    u32 u4AWBWinResultBuffAddr;// must be 66(registers) x 4(32 bits) = 264 bytes
    u32 u4AFWinResultBuffAddr;//must be 48(registers) x 4(32 bits) = 192 bytes
    u32 u4AEWinResultBuffAddr;//must be 20(registers) x 4(32 bits) =80 bytes
    u32 u4AEHistResultBufferAddr;// 64 x 4 = 256 bytes
    u32 u4HistResultBufferAddr;// 64 x 4 = 256 bytes
*/
