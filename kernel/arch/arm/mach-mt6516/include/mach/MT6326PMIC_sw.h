...
#if 0
/* 20100319 for temp solution ---- */
#define PMIC_ADPT_VOLT_1_3 0
#define PMIC_ADPT_VOLT_1_5 1
#define PMIC_ADPT_VOLT_1_8 2
#define PMIC_ADPT_VOLT_2_5 3
#define PMIC_ADPT_VOLT_2_8 4
#define PMIC_ADPT_VOLT_3_0 5
#define PMIC_ADPT_VOLT_3_3 6
/* --------------------------- */
#endif
...
extern void pmic_vrf_sel(kal_uint8 val);
...
extern void pmic_vtcxo_sel(kal_uint8 val);
...
// (0x37) LDO CTRL 30 VSIM
extern void pmic_vsim_sel(vsim_sel_enum sel);
...
// (0x3B) LDO CTRL 34 VUSB
extern void pmic_vusb_sel(kal_uint8 val);
