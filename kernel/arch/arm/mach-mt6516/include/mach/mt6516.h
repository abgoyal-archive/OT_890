...
#ifndef __ASM_ARCH_MT6516_H
#define __ASM_ARCH_MT6516_H
...
#define MT6516_PA_UART      (IO_PHYS + 0x00025000)     //0x80250000
#define MT6516_VA_UART      (IO_VIRT + 0x00025000)     //0xf0250000
#define MT6516_UART_SIZE    0x1000


/*---------------------------------------------*/

/*
 *  MT6516 HAL (FIXME : the file is copied from MT6516, most value of it should 
 *  be update for MT6516)
 */
...
//#define MT6516_INTH_VIRT            (IO_VIRT + 0x00022000)
//#define MT6516_GPT_VIRT             (IO_VIRT + 0x0002A000)

#define MT6516_INTH_VIRT            (IO_VIRT + 0x00021000)
#define MT6516_APGPT_VIRT           (IO_VIRT + 0x00026000)
#define MT6516_APXGPT_VIRT          (IO_VIRT + 0x0003E000)
...
#define MT6516_REG_IRQ_STA2 0x0078
#define MT6516_REG_EINT_STA 0x0100
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
// MT6516 XGPT - Extend Gerneral Purpose Timer Registers

#define MT6516_XGPT_IRQEN	    (MT6516_APXGPT_VIRT+0x00)
#define MT6516_XGPT_IRQSTA      (MT6516_APXGPT_VIRT+0x04)
#define MT6516_XGPT_IRQACK      (MT6516_APXGPT_VIRT+0x08)
#define MT6516_XGPT1_CON        (MT6516_APXGPT_VIRT+0x10)
#define MT6516_XGPT1_PRESCALE   (MT6516_APXGPT_VIRT+0x14)
#define MT6516_XGPT1_COUNT      (MT6516_APXGPT_VIRT+0x18)
#define MT6516_XGPT1_COMPARE    (MT6516_APXGPT_VIRT+0x1c)
#define MT6516_XGPT2_CON        (MT6516_APXGPT_VIRT+0x20)
#define MT6516_XGPT2_PRESCALE   (MT6516_APXGPT_VIRT+0x24)
#define MT6516_XGPT2_COUNT      (MT6516_APXGPT_VIRT+0x28)
#define MT6516_XGPT2_COMPARE    (MT6516_APXGPT_VIRT+0x2c)
#define MT6516_XGPT3_CON        (MT6516_APXGPT_VIRT+0x30)
#define MT6516_XGPT3_PRESCALE   (MT6516_APXGPT_VIRT+0x34)
#define MT6516_XGPT3_COUNT      (MT6516_APXGPT_VIRT+0x38)
#define MT6516_XGPT3_COMPARE    (MT6516_APXGPT_VIRT+0x3c)
#define MT6516_XGPT4_CON        (MT6516_APXGPT_VIRT+0x40)
#define MT6516_XGPT4_PRESCALE   (MT6516_APXGPT_VIRT+0x44)
#define MT6516_XGPT4_COUNT      (MT6516_APXGPT_VIRT+0x48)
#define MT6516_XGPT4_COMPARE    (MT6516_APXGPT_VIRT+0x4c)
#define MT6516_XGPT5_CON        (MT6516_APXGPT_VIRT+0x50)
#define MT6516_XGPT5_PRESCALE   (MT6516_APXGPT_VIRT+0x54)
#define MT6516_XGPT5_COUNT      (MT6516_APXGPT_VIRT+0x58)
#define MT6516_XGPT5_COMPARE    (MT6516_APXGPT_VIRT+0x5c)
#define MT6516_XGPT6_CON        (MT6516_APXGPT_VIRT+0x60)
#define MT6516_XGPT6_PRESCALE   (MT6516_APXGPT_VIRT+0x64)
#define MT6516_XGPT6_COUNT      (MT6516_APXGPT_VIRT+0x68)
#define MT6516_XGPT6_COMPARE    (MT6516_APXGPT_VIRT+0x6c)
#define MT6516_XGPT7_CON        (MT6516_APXGPT_VIRT+0x70)
#define MT6516_XGPT7_PRESCALE   (MT6516_APXGPT_VIRT+0x74)
#define MT6516_XGPT7_COUNT      (MT6516_APXGPT_VIRT+0x78)
#define MT6516_XGPT7_COMPARE    (MT6516_APXGPT_VIRT+0x7c)

//----------------------------------------------------------------------------
// MT6516 GPT - Gerneral Purpose Timer Registers

#define MT6516_GPT1_CON	      (MT6516_APGPT_VIRT+0x00)
#define MT6516_GPT1_DAT       (MT6516_APGPT_VIRT+0x04)
#define MT6516_GPT2_CON       (MT6516_APGPT_VIRT+0x08)
#define MT6516_GPT2_DAT       (MT6516_APGPT_VIRT+0x0c)
#define MT6516_GPT_STA        (MT6516_APGPT_VIRT+0x10)
#define MT6516_GPT1_PRESCALE  (MT6516_APGPT_VIRT+0x14)
#define MT6516_GPT2_PRESCALE  (MT6516_APGPT_VIRT+0x18)
#define MT6516_GPT3_CON       (MT6516_APGPT_VIRT+0x1c)
#define MT6516_GPT3_DAT       (MT6516_APGPT_VIRT+0x20)
#define MT6516_GPT3_PRESCALE  (MT6516_APGPT_VIRT+0x24)

#endif /* __ASM_ARCH_MT6516_H */
