 ...
 *
 * Function List :
 *					mt6516_wdt_SetTimeOutValue
 *					mt6516_wdt_SetResetLength
 *					mt6516_wdt_ModeSelection
 *					mt6516_wdt_Restart (keepalive)
 *					mt6516_wdt_SWTrigger
 *					mt6516_wdt_CheckStatus
 *					mt6516_wdt_SW_MCUPeripheralReset (Doma not use)
 *					mt6516_wdt_SW_MMPeripheralReset (Doma not use)
 */
...
/*
 * MT6516 WatchDogTimer's interrupt handler
 */
