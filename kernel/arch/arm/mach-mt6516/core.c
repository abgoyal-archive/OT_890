 ...
 * 
 * DESCRIPTION:
 *   This is the MTK sched_clock implementation and it overwrites kernel 
 *   default sched_clock for providing higher thread clock
 *
 *   This has a resolution of 76.92ns 
 *		- (1) HW clock = 13 (MHz)
 *		- (2) 1000_000_000 (ns) / 13_000_000 (HZ) = 76.92 (ns / HZ)
 *
 * PARAMETERS: 
 *   None
 * 
 ...
 * 
 * DESCRIPTION:
 *   Initialize XGPT1 for system timer
 * 
 * PARAMETERS: 
 *   None
 * 
 ...
 * NOTES: 
 *   CHECK_ME !!
 *   	XGPT1~2 are based on 13MHz. XGPT3~7 are based on 32kHz
 *      XGPT3~7 cannot be used as system timer 
 *             because 32kHz (32768) is not a multiple of 100
 * 
 * modification history
 * -----------------------------------------------
 * 20090430, Shu-Hsin written
