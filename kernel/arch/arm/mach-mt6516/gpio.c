...
/******************************************************************************
 * mt6516_gpio.c - MT6516 Linux GPIO Device Driver
 * 
 ...
 * 
 * DESCRIPTION:
 *   Set the gpio u4pin as Pull-Up/Pull-Down enable value ! 
 * 
 * PARAMETERS: 
 *   u4Pin: gpio pin number
 *   bPullEn:  Pull-Up/Pull-Down enable, enable 1, disable 0
 * 
 * RETURNS: 
 *   RSUCCESS : Success
 *   -EEXCESSPINNO : Excess Pin number
 ...
 * 
 * DESCRIPTION: 
 *   Get the gpio u4pin as Pull-Up/Pull-Down enable value ! 
 * 
 * PARAMETERS: 
 *   u4Pin: gpio pin number
 * 
 * RETURNS: 
 *    The value of u4Pin's pull enable, 0 disable, 1 enable
 * 
 * NOTES: 
 *   None
 * 
 ...
 * 
 * DESCRIPTION: 
 *   Set the gpio u4pin as Pull-Up or Pull-Down
 * 
 * PARAMETERS: 
 *   u4Pin: gpio pin number
 *   bPullSel : Pull-Up/Pull-Down selection, 0: pull-down, 1: pull-up
 * 
 * RETURNS: 
 *   RSUCCESS : success
 *   -EEXCESSPINNO : Excess Pin number
 ...
 * 
 * DESCRIPTION: 
 *   Get the gpio u4pin's pull selection value! 
 * 
 * PARAMETERS: 
 *   u4Pin: gpio pin number
 * 
 * RETURNS: 
 *    The value of u4Pin's pull selection value. 0: pull-down; 1: pull-up
 * 
 * NOTES: 
 *   None
 * 
 ...
 * 
 * DESCRIPTION: 
 *   Set the gpio u4pin as bInvEn enable value
 * 
 * PARAMETERS: 
 *   u4Pin: gpio pin number
 *   bInvEn : data inversion enable, 0: disable, 1: enable
 * 
 * RETURNS: 
 *   RSUCCESS : success
 *   -EEXCESSPINNO : Excess Pin number
 ...
 * 
 * DESCRIPTION: 
 *   Get the gpio u4pin as data inversion enable value ! 
 * 
 * PARAMETERS: 
 *   u4Pin: gpio pin number
 * 
 * RETURNS: 
 *    The value of u4Pin's data inversion enable, 0 disable, 1 enable
 * 
 * NOTES: 
 *   None
 * 
 ...
 * 
 * DESCRIPTION: 
 *   Set the gpio u4pin as mode value u4Mode! 
 * 
 * PARAMETERS: 
 *   u4Pin: gpio pin number
 *   u4Mode: gpio mode value, 0~3
 * 
 * RETURNS: 
 *   RSUCCESS : success
 *   -EEXCESSPINNO : Excess Pin number   
 ...
 * 
 * DESCRIPTION: 
 *   Get the gpio u4pin's mode value! 
 * 
 * PARAMETERS: 
 *   u4Pin: gpio pin number
 * 
 * RETURNS: 
 *   mode value of the u4Pin, 0~3
 *   -EEXCESSPINNO : Excess Pin number   
 * 
 * NOTES: 
 *   None
 ...
 * 
 * DESCRIPTION: 
 *   Set the clock output u4ClkOut as source value u4Src! 
 * 
 * PARAMETERS: 
 *   u4ClkOut: clock output
 *   u4Src: clock output source
 * 
 * RETURNS: 
 *   RSUCCESS : success
 *   -EEXCESSPINNO : Excess Pin number   
 ...
 * 
 * DESCRIPTION: 
 *   Get the clock output u4ClkOut's source value! 
 * 
 * PARAMETERS: 
 *   u4ClkOut: clock output
 * 
 * RETURNS: 
 *   source value of the u4ClkOut, 0~7
 *   -EEXCESSPINNO : Excess Pin number   
 * 
 * NOTES: 
 *   None
