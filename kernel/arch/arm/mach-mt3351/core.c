...
/* linux/arch/arm/mach-mt3351/core.c
 *
 * MT3351 Core 
 *
 * Copyright (C) 2008,2009 MediaTek <www.mediatek.com>
 * Authors: Angelo Lin    <angelo.lin@mediatek.com> 
...
/*
 * Irene 2008/09/17
 * The IRQ line of the interrupt source. 
 */
...
/**********************************************************
Description : Enable all of the interrupt mask
Input       : Interrupt code
Output      : Non
***********************************************************/
...
/**********************************************************
Description : Disable one of the interrupt source
Input       : Interrupt code
Output      : Non
***********************************************************/
...
/**********************************************************
Description : Disable one of the EINT interrupt source
Input       : Interrupt code
Output      : Non
Author      : Irene Liao
***********************************************************/
...
/**********************************************************
Description : Enable one of the EINT interrupt source
Input       : Interrupt code
Output      : Non
Author      : Irene Liao
***********************************************************/
...
/**********************************************************
Description : Clear the EINT interrupt 
Input       : Interrupt code
Output      : Non
Author      : Irene Liao
***********************************************************/
...
/**********************************************************
Description : FIQ Mask and Unmask
Input       : Non
Output      : Non
***********************************************************/
...
/**********************************************************
Description : Setting of IRQ sensitivity
Input       : Interrupt code and sensitivity
Output      : Non
***********************************************************/
...
/**********************************************************
Description : IRQ and FIQ source selection
Input       : Non
Output      : Non
***********************************************************/
