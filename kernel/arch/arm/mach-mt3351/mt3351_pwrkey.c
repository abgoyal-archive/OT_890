 ...
 * Function Call :
 *					PMU_PWRKEY_Enable
 *					PMU_PWRKEY_GetDEBSignal
 *					PMU_PWRKEY_GetNonDEBSignal
 */
...
/*
 * Test suite :
 *	               PMU_PwrKeyTest_LongPressThreeSeconds
 *	               PMU_PwrKeyTest_LongPressFiveSeconds
 *	               PMU_PwrKeyTest_LongPressEightSeconds
 *	               PMU_PwrKeyTest_LongPressTenSeconds
 *	               PMU_CheckDEBPwrKeySingal
 */
