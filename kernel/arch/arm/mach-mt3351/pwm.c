...
/******************************************************************************
 * mt3351_pwm.c - MT3351 Linux PWM Device Driver
 * 
 * Copyright 2008-2009 MediaTek Co.,Ltd.
 * 
 * DESCRIPTION:
 *     This file provid the other drivers PWM relative functions
 *
 ...
 * 
 * DESCRIPTION:
 *   Start the pwm sequential output mode !
 * 
 * PARAMETERS: 
 *   pwm_seq_en_cnt_e sequence
 *   typedef enum
 *   {
 *     PWM_SEQ_EN_PWM2      =0x1,
 ...
 * 
 * DESCRIPTION:
 *   Stop the pwm sequential output mode !
 * 
 * PARAMETERS: 
 *   None
 *
 ...
 * 
 * DESCRIPTION:
 *   Set the sequential output mode delays !
 * 
 * PARAMETERS: 
 *   u32 pwm_num
 *   u32 delay
 ...
 * 
 * DESCRIPTION:
 *   Configure the pwm register settings !
 *      CLK mode
 *      FIFO mode
 *      Memory mode
...
/******************************************************************************
 * pwm_enable_interrupt
 * 
 * DESCRIPTION:
 *   Enable or disable PWM interrupt!
 * 
 * PARAMETERS: 
 *   u32 pwm_num
 *   pwm_int_type_e int_type : underflow or finish interrupt
 *   bool is_enable : Enable the interrupt or not
 * 
 * RETURNS: 
 *   None  
 * 
 ...
 * 
 * DESCRIPTION:
 *   Setup the PWM4, PWM5 pinmux ! (GPIO 12, GPIO 13)
 * 
 * PARAMETERS: 
 *   None
 * 
 ...
 * 
 * NOTES: 
 *   Change this function if the PDN driver is ready !
 * 
 * modification history
 * -----------------------------------------------
 * 01a, 10 Dec 2008, Koshi, Chiu written
 ...
 * 
 * DESCRIPTION:
 *   Set the backlight level as the input level value ! 
 * 
 * PARAMETERS: 
 *   struct inode *inode
 *   struct file *file
 ...
 * 
 * PARAMETERS: 
 *   unsigned level : the backlight level
 * 
 * RETURNS: 
 *   RSUCCESS : Success   
 * 
 ...
 * 
 * DESCRIPTION:
 *   For the user application to use the pwm functionality ! 
 * 
 * PARAMETERS: 
 *   struct device *dev : device structure
 *   struct file *file
 *   unsigned int cmd : the command that user want to use
 *       IOW_BACKLIGHT_OFF: turn off the backlight!
 *       IOW_BACKLIGHT_ON: turn on the backlight!
 *       IOW_BACKLIGHT_UPDATE: update the backlight level (0~100)
 *       IOR_BACKLIGHT_CURRENT: get the current backlight level
 *   unsigned long arg : the arg that user application pass to the device driver
 * 
 * RETURNS: 
 *   RSUCCESS : Success   
 * 
 ...
 * 
 * DESCRIPTION:
 *   register the pwm device file operations ! 
 * 
 * PARAMETERS: 
 *   struct device *dev : device structure
 * 
 ...
 * 
 * DESCRIPTION:
 *   unregister the pwm device file operations ! 
 * 
 * PARAMETERS: 
 *   struct device *dev : device structure
 * 
 ...
 * 
 * DESCRIPTION:
 *   Register the pwm device driver ! 
 * 
 * PARAMETERS: 
 *   None
 * 
