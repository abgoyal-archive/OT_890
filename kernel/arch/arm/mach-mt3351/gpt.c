...
/******************************************************************************
 * gpt.c - This file is for the gpt driver !
 * 
 * Copyright 2008-2009 MediaTek Co.,Ltd.
 * 
 * DESCRIPTION: - 
 *     This file is a kernel module that includes essential functions about gpt driver !
 *
 * modification history
 * ----------------------------------------
 * 01a, 08 dec 2008, Shu-Hsin Chang written
 * ----------------------------------------
 ******************************************************************************/
...
/******************************************************************************
 Read / Write Register Macro
******************************************************************************/

/******************************************************************************
 GPT Timer Handler and Tasklet
******************************************************************************/
